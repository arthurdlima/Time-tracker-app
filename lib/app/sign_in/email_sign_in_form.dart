...
class EmailSignInForm extends StatefulWidget {
  ...
  const EmailSignInForm({@required this.auth, Key? key}) : super(key: key);
...
class _EmailSignInFormState extends State<EmailSignInForm> {
  ...
  _updateState() {
    //just to update screen for button block.
    //texteditingcontroller handles variable value atribution
    setState(() {});
  }
}
